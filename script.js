...
function checkAnswer(userAnswer) {
  ...
  if (userAnswer === correctAnswer) {
    ...
    feedbackElement.textContent = "Correct! It's a " + (correctAnswer ? "Fact" : "Cap") + ".";
  ...
  nextButton.classList.add('next-button'); // Add a class for potential styling
  // Append the button to the buttons container or game container
